...
import { CompanyData } from 'src/app/company-data';
import { chartOptions, donut } from 'src/app/shared/data/dashboard/dashboard01';
import { SidebarComponent } from 'src/app/shared/layout-components/sidebar/sidebar.component';
...
export class Dashboard01Component implements OnInit {
  ...
  static company:any;
  get company(){
    return Dashboard01Component.company;
  }
  public set company(value: any) {
    Dashboard01Component.company = value;
  }
  public lang: any;


  constructor(  private translate: TranslateService,private router: Router,private navService: NavService) {
  ...
  ngOnInit(): void {
    ...
    //SidebarComponent.menuItems = this.navService.BaseMENUITEMS;
    this.getCompanyData();
  }
  getCompanyData() {
  ...
  changeDash(){
    ...
    // SidebarComponent.menuItems = this.navService.HRMENUITEMS;
}
}
